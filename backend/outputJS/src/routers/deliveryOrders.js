...
router.get("/all/completed", authUsers_1.auth, deliveryOrders_1.getAllCompletedStoreDeliveryOrders);
router.get("/all/pending", authUsers_1.auth, deliveryOrders_1.getAllPendingStoreDeliveryOrders);
